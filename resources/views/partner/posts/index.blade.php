...
<div class="min-h-screen bg-gray-100 py-8">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">My Commission Posts</h1>
                <p class="text-gray-600 mt-1">Manage your tuition posts with commission</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <h3 class="text-3xl font-bold text-blue-600 mt-1">{{ $stats['applications'] }}</h3>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <p class="text-gray-500 text-sm">Confirmed</p>
                <h3 class="text-3xl font-bold text-purple-600 mt-1">{{ $stats['confirmed'] }}</h3>
            </div>
        </div>
        ...
        <div class="space-y-4">
            @forelse($posts as $post)
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm mt-1">
                                Guardian: {{ $post->guardian->user->full_name }}
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4 py-4 border-y border-gray-200">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-800">{{ $post->created_at->format('d M Y') }}</p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500">Expires</p>
                            <p class="font-semibold text-gray-800">{{ $post->expires_at->format('d M Y') }}</p>
                        </div>
                    </div>
            ...
            @empty
                <div class="bg-white rounded-lg shadow p-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Create your first commission post to start earning.</p>
                    <div class="mt-6">
                        <a href="{{ route('partner.posts.create') }}" 

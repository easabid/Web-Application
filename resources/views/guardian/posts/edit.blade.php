...
<div class="min-h-screen bg-gray-100 py-8">
    <div class="max-w-4xl mx-auto px-4">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('guardian.posts.show', $post->id) }}" class="text-blue-600 hover:text-blue-700 flex items-center gap-2 mb-3">
            ...
            <p class="text-gray-600 mt-1">Update your tuition post details</p>
        </div>

        <form action="{{ route('guardian.posts.update', $post->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')

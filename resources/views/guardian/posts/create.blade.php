...
<div class="min-h-screen bg-gray-100 py-8">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <p class="text-gray-600 mb-6">Post your tuition requirement to find suitable tutors.</p>

            <form action="{{ route('guardian.posts.store') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-between pt-4 border-t">
                    <a href="{{ route('guardian.posts.index') }}" class="text-gray-600 hover:text-gray-800">
                        Cancel
                    </a>
                    <button type="submit" 
